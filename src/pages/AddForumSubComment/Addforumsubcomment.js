...
function Addforumsubcomment({user}){
    ...
    const { cid , name , commentbody } = location.state;
    console.log(cid)
        ...
        <div>
            <form className="courseform">
                ...
                <div className="buttons">
                    ...
                    <Link to="/forum/questions" ><button type="submit" onClick={()=>{addSubcomment(cid,user)}} className="btn btn-primary">Submit</button></Link>
                </div>
